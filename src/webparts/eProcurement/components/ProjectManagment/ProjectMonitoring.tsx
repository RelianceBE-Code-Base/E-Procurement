...
export interface Project {
    ...
    startDate: string;
    endDate: string;
    assignedOfficer: string;  // Government officer overseeing the project
...
const ProjectMonitoring: React.FC = () => {
    ...
    //                         <p className="text-lg font-bold">${(totalContractValue / 1000000).toFixed(1)}M</p>
    //                     </div>
    //                 </div>
    //             </CardContent>
    //         </Card>
...
//     <button
//         onClick={onClick}
//         className={`px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center ${className}`}
//     >
//         {children}
//     </button>
// );
